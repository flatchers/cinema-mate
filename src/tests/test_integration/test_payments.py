...
from database.models import OrderModel, PaymentModel, OrderItemModel
...
@pytest.mark.asyncio
async def test_payment_add(mock_payment_add, client, db_session):
    payload_register = {
...
@patch("src.routes.payments.stripe.checkout.Session.create")
@pytest.mark.asyncio
async def test_payment_add_409_invalid_scenarios(mock_payment_add, client, db_session):
    payload_register = {
        "email": "testuser@example.com",
        "password": "StrongPassword123!"
    }
