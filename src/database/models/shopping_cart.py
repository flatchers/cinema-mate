...
from sqlalchemy import Integer, ForeignKey, DateTime, func, UniqueConstraint, Table, Column
...
NotificationModeratorsModel = Table(
    ...
    Column("notifications_delete_id", ForeignKey("notifications_delete.id"), primary_key=True, nullable=False),
)
